...
<!-- 		<img class="header" src="img/small bar.png"> -->
	...
	<!-- Right-hand content -->
	<!-- 
	<div class="mainDiv" id="right"><img class="divHead" src="img/mission.png"></br><div></br>The Liberty Robotics Foundation, a not for profit
	501c3, was founded in 2009 by parents of the liberty robotics team promote the expansion of FIRST teams in the Liberty School District</div>
